...
top_admm_step_size__z = 0.0025; % for TOP-ADMM


switch lower(select__method)
    ...
    case 'top_admm'
        ...
        [x_topadmm, history_topadmm] = distr_l1_logreg_topadmm(A0, b0, mu, M, rho, gamma, alpha_relax, top_admm_step_size__z); % it is a cyclic and updates shuffled version to analyze the convergence
        ...
        legend_list = [legend_list; sprintf('TOP-ADMM: %1.2f%% training error; \\tau=%1.5f', ...
            (100-pctcorrec_topadmm), top_admm_step_size__z)];
